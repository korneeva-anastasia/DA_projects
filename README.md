...
| 2 | [АиФ Доброе сердце: ETL, витрина данных]() | Реализован скрипт для загрузки и подготовки данных + витрина данных, построенная по результатам работы скрипта. Проведен RFM-анализ, когортный анализ (Retention, LTV, AOV, Churn). Построен дашборд в Datalens | python, pandas, sqlalchemy, os, yadisk, dotenv |
